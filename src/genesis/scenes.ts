...
const SCENE_DATA: readonly Omit<Scene, 'start' | 'end'>[] = [
  ...
  },
  {
    ...
    body: NARRATION.closing,
    citation: 'A call to follow Christ',
    kind: 'exhortation',
    audio: 'closing.mp3',
    tick: 'Christ',
  },
  {
    ...
    body: NARRATION.doubt,
    citation: 'Faith and the universe',
    kind: 'science',
    audio: 'doubt.mp3',
    tick: 'Doubt',
  },
  {
    ...
    body: NARRATION.measure,
    citation: 'NASA · ESA Planck',
    kind: 'science',
    audio: 'measure.mp3',
    tick: 'Sky',
  },
