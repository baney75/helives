...
const SCENE_DATA: readonly Omit<Scene, 'start' | 'end'>[] = [
  ...
  {
    id: 'doubt',
    name: 'Faith and the universe',
    kicker: 'After Genesis',
    persistAfter: false,
    color: '#9bb4d4',
    headline: 'Genesis begins with God as creator.',
    body: 'Cosmology studies how the universe has developed. The questions overlap, but a measurement is not a verdict on faith.',
    citation: 'Not Scripture',
    kind: 'science',
    audio: 'doubt.mp3',
    tick: 'Doubt',
  },
  {
    ...
    body: 'The universe is expanding. The cosmic microwave background is light released early in its history. Together with other observations, it supports a universe about 13.8 billion years old within the standard cosmological model.',
